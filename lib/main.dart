...
class _ListViewPageState extends State<ListViewPage> {
  ...
  @override
  Widget build(BuildContext context) {
    // description 구간에서 반응형으로 공간 설정을 하기 위한 변수
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: titleList.length, // index 변수는 itemCount 수에서 반복문으로 나온 것안기??
        itemBuilder: (context, index){
          return GestureDetector( // 제스처 기능이 없는 경우 만들어주는 위젯
            onTap: (){
            ...
            child: Card(
              child: Row(
                children: [
                  SizedBox(   // const 속성을 가지고 있음, 공간을 확보하는 차원에서는 Container보다는 SizedBox가 더 유용
                    width: 100,
                    height: 100,
